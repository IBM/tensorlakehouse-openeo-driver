...
- HELM (Just pick a [release]([https://github.com/kubernetes-sigs/kind/releases](https://github.com/helm/helm/releases)) for your platform, it is just one binary you need to add to you system's path)
